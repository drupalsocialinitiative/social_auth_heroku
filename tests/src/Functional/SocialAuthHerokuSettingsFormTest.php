...
/**
 * Test Social Auth Heroku settings form.
 *
 * @group social_auth
 *
 * @ingroup social_auth_heroku
 */
class SocialAuthHerokuSettingsFormTest extends SocialAuthTestBase {
   ...
   * @var array
   */
  public static $modules = ['social_auth_heroku'];

  /**
   * {@inheritdoc}
   */
  protected function setUp() {
    $this->module = 'social_auth_heroku';
