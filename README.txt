 ...
 * Composer Manager (https://www.drupal.org/project/composer_manager):
   This module will help to install the League PHP library and Heroku base library for the league,
   which are the libraries required to make user authentication.

INSTALLATION
------------

 * Download Heroku Base Library for TheLeague OAuth2 PHP library
   (https://github.com/thephpleague/oauth2-heroku). We recommend to use
...
User can click on the Heroku logo on the Social Auth Login block
...
user to Heroku Accounts for authentication. Heroku then returns the user to
...
admin/reports/composer-manager. This status page will show the Heroku The League OAuth2 Base
